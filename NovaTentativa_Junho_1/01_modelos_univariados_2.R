...
# Exportar para CSV
write.csv(resultados_garch, "volatilidades_previstas_completo_corrigido_GARCH.csv", row.names = FALSE)

# Métricas só para o GARCH
preds_GARCH <- read.csv("volatilidades_previstas_completo_corrigido_GARCH.csv")
