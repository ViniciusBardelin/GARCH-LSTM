...
# funcao para criar janelas deslizantes
...
# funcao para treinar e avaliar a rede LSTM
...
# funcao para treinar e salvar previsões do modelo híbrido
...
# funcao para treinar e selecionar o melhor modelo com base no QLIKE
