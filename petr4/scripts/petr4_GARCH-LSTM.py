...
plt.plot(predictions_df["Date"], predictions_df["Predicted Values"], label="Predicted Values (GARCH-LSTM)", color="red", linestyle="--", alpha=0.7)
plt.xlabel("Date")
...
plt.grid()
plt.tight_layout()
plt.savefig("comparison_proxy_garch_lstm_petrobras.png")
plt.savefig("comparison_proxy_garch_lstm_petrobras.pdf")
plt.show()
